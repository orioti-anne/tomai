...
def get_models():
    ...
    if _disease_model is None:
        ...
        _inspector_model.names = {
            0: 'Premium', 1: 'Ugly', 2: 'Discard', 3: 'unripe'
        }
        _disease_model.names = {
            0: 'Early Blight', 1: 'Healthy', 2:'Late Blight', 3:'Leaf Miner', 4:'Leaf Mold', 5:'Mosaic Virus', 6:'Septoria', 7:'Spider Mites', 8:'Yellow Leaf Curl Virus'
        }

        _quality_model.names = {
            0: 'anthracnose', 1: 'blossom_end_rot', 2: 'brown_rugose', 3:'fruit_cracking', 4:'half_ripe', 5:'mold', 6:'ripe', 7:'rotten', 8:'sunscald', 9:'unripe'
        }
        _seg_model.names = {
            0: 'tomato', 1: 'tom_fruit_breaker_poly', 2: 'tom_fruit_pink_poly', 3: 'tom_fruit_red_poly'
        }
